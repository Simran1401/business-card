...
function selectImage(image) {
    ...
    var selectedImageUrl = image.getAttribute('src');   
    document.getElementById('selected__image').src = selectedImageUrl;
    ...
    console.log('Selected Image ID:', selectedImageUrl);
    localStorage.setItem('selectedImageurl', selectedImageUrl);

    // Close the modal
    var modal = new bootstrap.Modal(document.getElementById('modal_bgImg'));
    modal.hide();
}
